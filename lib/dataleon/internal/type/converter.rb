    ...
    module Type
      ...
      module Converter
        ...
        def dump(value, state:)
          case value
          in Array
            value.map { Dataleon::Internal::Type::Unknown.dump(_1, state: state) }
          in Hash
            value.transform_values { Dataleon::Internal::Type::Unknown.dump(_1, state: state) }
          ...
          in Pathname | IO
            ...
            Dataleon::FilePart.new(value)
          in Dataleon::FilePart
        ...
        class << self
          ...
          def type_info(spec)
            ...
            in Dataleon::Internal::Type::Converter | Class | Symbol
              -> { spec }
          ...
          #
          # @param target [Dataleon::Internal::Type::Converter, Class]
          #
          # @param value [Object]
          #
          ...
          #
          # @return [Object]
          def coerce(target, value, state: Dataleon::Internal::Type::Converter.new_coerce_state)
            # rubocop:disable Metrics/BlockNesting
            exactness = state.fetch(:exactness)

            case target
            in Dataleon::Internal::Type::Converter
          ...
          def dump(target, value, state: {can_retry: true})
            ...
            in Dataleon::Internal::Type::Converter
              ...
              Dataleon::Internal::Type::Unknown.dump(value, state: state)
            end
          end
        ...
        define_sorbet_constant!(:Input) do
          T.type_alias { T.any(Dataleon::Internal::Type::Converter, T::Class[T.anything]) }
        end
