...
class Dataleon::Test::SingletonClient < Dataleon::Client
  include Singleton

  TEST_API_BASE_URL = ENV.fetch("TEST_API_BASE_URL", "http://localhost:4010")

  def initialize
    super(base_url: Dataleon::Test::SingletonClient::TEST_API_BASE_URL, api_key: "My API Key")
  end
end
...
class Dataleon::Test::ResourceTest < Minitest::Test
  def async?
  ...
  def before_all
    super
    @dataleon = Dataleon::Test::SingletonClient.instance
  end
