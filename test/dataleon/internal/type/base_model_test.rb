...
class Dataleon::Test::PrimitiveModelTest < Minitest::Test
  A = Dataleon::Internal::Type::ArrayOf[-> { Integer }]
  H = Dataleon::Internal::Type::HashOf[-> { Integer }, nil?: true]
  ...
  module U
    extend Dataleon::Internal::Type::Union
  end

  class B < Dataleon::Internal::Type::BaseModel
    optional :a, Integer
    optional :b, B
  end
  ...
  def test_typing
    converters = [
      Dataleon::Internal::Type::Unknown,
      Dataleon::Internal::Type::Boolean,
      A,
      H,
      E,
      U,
    ...
    converters.each do |conv|
      assert_pattern do
        conv => Dataleon::Internal::Type::Converter
      end
    end
  end
  ...
  def test_coerce
    cases = {
      [Dataleon::Internal::Type::Unknown, :a] => [{yes: 1}, :a],
      [NilClass, :a] => [{maybe: 1}, nil],
      [NilClass, nil] => [{yes: 1}, nil],
      [Dataleon::Internal::Type::Boolean, true] => [{yes: 1}, true],
      [Dataleon::Internal::Type::Boolean, "true"] => [{no: 1}, "true"],
      [Integer, 1] => [{yes: 1}, 1],
    ...
    cases.each do |lhs, rhs|
      ...
      state = Dataleon::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        Dataleon::Internal::Type::Converter.coerce(target, input, state: state) => ^expect
  ...
  def test_dump
    cases = {
      [Dataleon::Internal::Type::Unknown, B.new(a: "one", b: B.new(a: 1.0))] => {a: "one", b: {a: 1}},
      ...
      [Dataleon::Internal::Type::Boolean, true] => true,
      [Dataleon::Internal::Type::Boolean, "true"] => "true",
      [Integer, "1"] => "1",
      [Float, 1] => 1,
      [String, "one"] => "one",
      ...
      [String, Pathname(__FILE__)] => Dataleon::FilePart
    }
    ...
    cases.each do
      ...
      expect = _2
      assert_pattern do
        Dataleon::Internal::Type::Converter.dump(target, input) => ^expect
      end
    end
  end
  ...
  def test_coerce_errors
    ...
    cases.each do |testcase, expect|
      ...
      state = Dataleon::Internal::Type::Converter.new_coerce_state
      Dataleon::Internal::Type::Converter.coerce(target, input, state: state)
      assert_pattern do
        state => {error: ^expect}
      end
    end
  ...
  def test_dump_retry
    ...
    Pathname(__FILE__).open do |fd|
      ...
      types.product(cases).each do |target, input|
        ...
        Dataleon::Internal::Type::Converter.dump(target, input, state: state)
...
class Dataleon::Test::EnumModelTest < Minitest::Test
  class E0
    include Dataleon::Internal::Type::Enum
    attr_reader :values
...
class Dataleon::Test::CollectionModelTest < Minitest::Test
  A1 = Dataleon::Internal::Type::ArrayOf[-> { Integer }]
  H1 = Dataleon::Internal::Type::HashOf[Integer]

  A2 = Dataleon::Internal::Type::ArrayOf[H1]
  H2 = Dataleon::Internal::Type::HashOf[-> { A1 }]

  A3 = Dataleon::Internal::Type::ArrayOf[Integer, nil?: true]
  H3 = Dataleon::Internal::Type::HashOf[Integer, nil?: true]
...
class Dataleon::Test::BaseModelTest < Minitest::Test
  class M1 < Dataleon::Internal::Type::BaseModel
    required :a, Integer
  end
  ...
  class M3 < Dataleon::Internal::Type::BaseModel
    optional :c, const: :c
    required :d, const: :d
  end
  ...
  class M5 < Dataleon::Internal::Type::BaseModel
    request_only do
      required :c, const: :c
    end
  ...
  class M6 < M1
    required :a, Dataleon::Internal::Type::ArrayOf[M6]
    optional :b, M6
  end
  ...
  def test_coerce
    ...
    cases.each do |lhs, rhs|
      ...
      state = Dataleon::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        coerced = Dataleon::Internal::Type::Converter.coerce(target, input, state: state)
        assert_equal(coerced, coerced)
        if coerced.is_a?(Dataleon::Internal::Type::BaseModel)
          coerced.to_h => ^expect
        else
          coerced => ^expect
        end
      ...
      attributes.each do |accessor, expect|
        ...
        in Class if expect <= StandardError
          tap do
            ...
            flunk
          rescue Dataleon::Errors::ConversionError => e
...
class Dataleon::Test::UnionTest < Minitest::Test
  class U0
    include Dataleon::Internal::Type::Union
  ...
  class M2 < Dataleon::Internal::Type::BaseModel
  ...
  class M4 < Dataleon::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :a, Dataleon::Internal::Type::ArrayOf[-> { U5 }]
  end

  class M5 < Dataleon::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :b, Dataleon::Internal::Type::ArrayOf[-> { U5 }]
  end
...
class Dataleon::Test::BaseModelQoLTest < Minitest::Test
  class E0
    include Dataleon::Internal::Type::Enum
    attr_reader :values
  ...
  def test_equality
    cases = {
      [Dataleon::Internal::Type::Unknown, Dataleon::Internal::Type::Unknown] => true,
      [Dataleon::Internal::Type::Boolean, Dataleon::Internal::Type::Boolean] => true,
      [Dataleon::Internal::Type::Unknown, Dataleon::Internal::Type::Boolean] => false,
...
class Dataleon::Test::MetaInfoTest < Minitest::Test
  A1 = Dataleon::Internal::Type::ArrayOf[Integer, nil?: true, doc: "dog"]
  H1 = Dataleon::Internal::Type::HashOf[-> { String }, nil?: true, doc: "dawg"]
