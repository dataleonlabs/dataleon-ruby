    ...
    module Transport
      ...
      class BaseClient
          ...
          T.type_alias do
            {
              ...
              page:
                T.nilable(
                  T::Class[
                    Dataleon::Internal::Type::BasePage[
        ...
        class << self
          ...
          sig do
            params(
              status: T.any(Integer, Dataleon::Errors::APIConnectionError),
        ...
        # @api private
        sig { returns(Dataleon::Internal::Transport::PooledNetRequester) }
        ...
        sig do
          overridable
            .params(
              req: Dataleon::Internal::Transport::BaseClient::RequestComponents,
              opts: Dataleon::Internal::AnyHash
            )
            .returns(Dataleon::Internal::Transport::BaseClient::RequestInput)
        end
        ...
        def request(
          ...
          page: nil,
          stream: nil,
          model: Dataleon::Internal::Type::Unknown,
          options: {}
        )
        end
